      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <svg
                class="w-6 h-6 text-red-400 mb-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div
          v-else
          class="flex flex-col items-center p-3 rounded-lg border border-gray-200 hover:border-green-500 transition-colors"
        >
          ...
          <template v-else>
            ...
            >
              <svg
                class="w-8 h-8 text-red-400 mb-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
