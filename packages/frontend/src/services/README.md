...
Simple utility functions for handling contract plan filtering and selection logic.
...
```typescript
import { getAvailablePlans, requiresDistance, shouldShowPriceTable, getPlanDetails } from '../services/planSelection'
...
- `shouldShowPriceTable(contractType, planId, distance?)` - Returns true if price table should show
