 ...
 */
export function shouldShowPriceTable(contractType: string, planId: string, distance?: string): boolean {
 ...
 */
export function getPlanOptions(contractType: ContractType | ''): Array<{ value: string; label: string }> {
  const plans = getAvailablePlans(contractType)
