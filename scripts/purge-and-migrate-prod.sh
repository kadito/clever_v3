...
# =============================================================
# Purge R2 prod bucket and run all migration scripts
# Usage: bash scripts/purge-and-migrate-prod.sh
# =============================================================
...
export CF_R2_BUCKET_NAME="clever-content-prod"

# Contracts migration uses different env var names
export R2_BUCKET_NAME="clever-content-prod"
export KV_NAMESPACE_ID="5e716e1caf904a67a709b033f981cac1"

SCRIPTS_DIR="$(cd "$(dirname "$0")" && pwd)"

echo "==========================================="
echo " CLEVER - Purge & Migrate (PROD environment)"
echo "==========================================="
echo ""

# Step 1: Purge R2 bucket
echo ">>> [1/6] Purging R2 bucket: clever-content-prod..."
node "$SCRIPTS_DIR/purge-r2.mjs" clever-content-prod
echo ""
