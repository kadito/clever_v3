<template>
  <div class="conta-corrente-module">
    <div class="module-header">
      ...
      <div class="module-info">
        ...
        <div class="module-content">
          ...
          <p class="module-description">Gestão de faturas e conta corrente de clientes</p>
        </div>
      </div>
    </div>
    ...
    <div class="module-actions">
      ...
      <button @click="navigateToCreate" class="action-btn secondary">
        ...
        <span class="action-description">Criar um novo registo de conta corrente</span>
      </button>
    </div>
  </div>
</template>
