          ...
          <div class="form-group displacement-options">
            ...
            <div class="radio-group">
              <label :class="['radio-label', form.displacement.hasDisplacement ? 'selected' : '']">
                <input type="radio" v-model="form.displacement.hasDisplacement" :value="true" name="displacement">
                <span>SIM</span>
              </label>
              <label :class="['radio-label', !form.displacement.hasDisplacement ? 'selected' : '']">
                <input type="radio" v-model="form.displacement.hasDisplacement" :value="false" name="displacement">
                <span>NÃO</span>
              </label>
            </div>
          </div>
      ...
      <section class="form-section">
        ...
        <div class="form-grid">
          <div class="payment-options">
            <label :class="['payment-option', form.displacement.paymentMethod === 'PENDENTE' ? 'selected' : '']">
              <input type="radio" v-model="form.displacement.paymentMethod" value="PENDENTE" name="payment">
              <span>PENDENTE</span>
            </label>
            <label :class="['payment-option', form.displacement.paymentMethod === 'CARTÃO MB' ? 'selected' : '']">
              <input type="radio" v-model="form.displacement.paymentMethod" value="CARTÃO MB" name="payment">
              <span>CARTÃO MB</span>
            </label>
            <label :class="['payment-option', form.displacement.paymentMethod === 'DINHEIRO' ? 'selected' : '']">
              <input type="radio" v-model="form.displacement.paymentMethod" value="DINHEIRO" name="payment">
              <span>DINHEIRO</span>
            </label>
            <label :class="['payment-option', form.displacement.paymentMethod === 'TRANSFERÊNCIA BANCÁRIA' ? 'selected' : '']">
              <input type="radio" v-model="form.displacement.paymentMethod" value="TRANSFERÊNCIA BANCÁRIA" name="payment">
              <span>TRANSFERÊNCIA BANCÁRIA</span>
            </label>
            <label :class="['payment-option', form.displacement.paymentMethod === 'CONTRATO' ? 'selected' : '']">
              <input type="radio" v-model="form.displacement.paymentMethod" value="CONTRATO" name="payment">
              <span>CONTRATO</span>
            </label>
          </div>
        </div>
      ...
      <section class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group full-width">
            ...
            <div>
              <small class="form-text">Toque no botão acima para desenhar a assinatura. A assinatura será guardada automaticamente ao submeter o formulário.</small>
            </div>
          </div>
        </div>
      </section>
...
// Watchers
watch(selectedFolha, (newValue, oldValue) => {
  console.log('selectedFolha watcher triggered:', { newValue, oldValue, isEditing: isEditing.value })
...
watch(() => form.displacement.oneWayKms, (newValue) => {
...
watch(() => form.otherData.materialUsed, (newValue) => {
  if (!newValue) {
...
watch(() => form.otherData.equipment, (newValue) => {
  if (!newValue) {
...
watch(() => form.otherData.totallyResolved, (newValue) => {
  if (newValue) {
...
watch(() => form.displacement.paymentMethod, (newValue) => {
