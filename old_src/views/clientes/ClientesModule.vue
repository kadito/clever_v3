  ...
  <div class="clientes-module">
    <div class="module-header">
      ...
      <div class="module-info">
        ...
        <div class="module-content">
          <h1>Clientes</h1>
          <p class="module-description">Gestão de clientes</p>
        </div>
      </div>
    </div>
    ...
    <div class="module-actions">
      <button @click="navigateToList" class="action-btn primary">
        ...
        <span class="action-description">Ver lista de clientes</span>
      </button>
      
      <button @click="navigateToCreate" class="action-btn secondary">
        <span class="action-icon">➕</span>
        <span class="action-label">NOVO CLIENTE</span>
        <span class="action-description">Criar um novo cliente</span>
      </button>
    </div>
  </div>
</template>
