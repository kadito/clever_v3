...
CLEVER Dashboard is an internal business management application for a Portuguese service company. The system manages various operational aspects including:
...
## Language
The application is primarily in Portuguese, reflecting its target market. All UI text, module names, and business terminology should maintain Portuguese language conventions.

## Architecture
This is version 3 of the CLEVER system, being rebuilt as a modern monorepo with separate frontend and backend packages, replacing the legacy Vue 2 application in `old_src/`.
